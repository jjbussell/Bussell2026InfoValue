...
% Used for 4 center port odor task (info vs water value)
    ...
    %% DAQ SYNC
        ...
        if ~isempty(DAQfiles)
            ...
            for ff=1:numel(DAQfiles)
                ...
                % check these manually; DAQdata changes based on whether
                % behavior tracking camera set up on rig
