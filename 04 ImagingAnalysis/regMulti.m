...
% mouse='JB566';
% base='20250818';
% days={'20251211','20251212','20260107','20260108'};
mouse='JB581';
base='20260226';
days={'20260219','20260226','20260227','20260303'};


% mouse='JB589';
% base='20260414';
% days={'20260505','20260506','20260507','20260508'};

% mouse='JB551';
% base='20251110';
% days={'20251110','20251111'};


% datapath=fullfile('C:\Users\Axel\Bussell Dropbox\Bussell Lab\BpodInfoseek\Analysis',[mouse '_pipeline']);
% datapath=fullfile('D:\Bussell Dropbox\Bussell Lab\BpodInfoseek\Analysis',[mouse '_pipeline']);
...
% options_mc = NoRMCorreSetParms('d1',options.d1,'d2',options.d2,'max_shift',1000,'iter',2,'correct_bidir',false);
