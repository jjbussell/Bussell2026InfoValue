...
%}
function TotalRewardDisplayInfo(varargin)
% TotalRewardDisplayInfo('init') - initializes a window that displays total reward
% TotalRewardDisplayInfo('add', Amount) - updates the total reward display with
