 ...
 * 
 * 
  Modified from DIO.ino, part of the Sanworks Bpod_Gen2 repository
...
// Pins 2-4 are configured as input channels, pins 5-23 are configured as output channels.
// A 2-byte serial message from the state machine sets the state of the output lines: [Channel (8-13), State(0 or 1)].
