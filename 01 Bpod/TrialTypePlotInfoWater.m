...
function TrialTypePlotInfoWater(AxesHandle, Action, varargin)
%% 
...
%Example usage:
% TrialTypePlotInfoWater(AxesHandle,'init',TrialTypes)
% TrialTypePlotInfoWater(AxesHandle,'init',TrialTypes,'ntrials',90)
% TrialTypePlotInfoWater(AxesHandle,'update',CurrentTrial,TrialTypes,OutcomeRecord)
...
%                                 4: correct choice small (magenta dot)
%                                 5: correct choice big (green dot)
...
% J. Bussell. Adapted for four center port odor water vs. information task.
...
switch Action
    case 'init'
        ...
        yticklabelsinfo = {'Big','RandForced','InfoForced','Small'};
        labelFontSize = 16;
        axes(AxesHandle);
        ...
        BpodSystem.GUIHandles.BigCorrectLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge','g','MarkerFace','g', 'MarkerSize',6);
        BpodSystem.GUIHandles.SmallCorrectLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge','m','MarkerFace','m', 'MarkerSize',6);
        ...
        BpodSystem.GUIHandles.NotPresentBigLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge','g','MarkerFace',[1 1 1], 'MarkerSize',6);
        BpodSystem.GUIHandles.NotPresentSmallLine = line([0,0],[0,0], 'LineStyle','none','Marker','o','MarkerEdge','m','MarkerFace',[1 1 1], 'MarkerSize',6);        
...
%             end
           ...
           % RAND BIG
           set(BpodSystem.GUIHandles.RandCorrectBigLine, 'xdata', [DispDatapast{3,1},DispDatapast{3,1}], 'ydata', [Ydatapast{3,1},Ydatapast{3,1}]);
           % RAND SMALL
           set(BpodSystem.GUIHandles.RandCorrectSmallLine, 'xdata', [DispDatapast{4,1},DispDatapast{4,1}], 'ydata', [Ydatapast{4,1},Ydatapast{4,1}]);
           % INFO BIG NP
           set(BpodSystem.GUIHandles.NotPresentInfoBigLine, 'xdata', [DispDatapast{5,1},DispDatapast{5,1}], 'ydata', [Ydatapast{5,1},Ydatapast{5,1}]);
           % INFO SMALL NP
           set(BpodSystem.GUIHandles.NotPresentInfoSmallLine, 'xdata', [DispDatapast{6,1},DispDatapast{6,1}], 'ydata', [Ydatapast{6,1},Ydatapast{6,1}]);
           % RAND BIG NP
           ...
           % BIG
           set(BpodSystem.GUIHandles.BigCorrectLine, 'xdata', [DispDatapast{9,1},DispDatapast{9,1}], 'ydata', [Ydatapast{9,1},Ydatapast{9,1}]);
           % SMALL
           set(BpodSystem.GUIHandles.SmallCorrectLine, 'xdata', [DispDatapast{10,1},DispDatapast{10,1}], 'ydata', [Ydatapast{10,1},Ydatapast{10,1}]);
           % BIG NP
           set(BpodSystem.GUIHandles.NotPresentBigLine, 'xdata', [DispDatapast{11,1},DispDatapast{11,1}], 'ydata', [Ydatapast{11,1},Ydatapast{11,1}]);
           % SMALL NP
           set(BpodSystem.GUIHandles.NotPresentSmallLine, 'xdata', [DispDatapast{12,1},DispDatapast{12,1}], 'ydata', [Ydatapast{12,1},Ydatapast{12,1}]);
           % INCORRECT
           set(BpodSystem.GUIHandles.IncorrectLine, 'xdata', [DispDatapast{13,1},DispDatapast{13,1}], 'ydata', [Ydatapast{13,1},Ydatapast{13,1}]);
           % NO CHOICE
           set(BpodSystem.GUIHandles.NoChoiceLine, 'xdata', [DispDatapast{14,1},DispDatapast{14,1}], 'ydata', [Ydatapast{14,1},Ydatapast{14,1}]);
        end
end
