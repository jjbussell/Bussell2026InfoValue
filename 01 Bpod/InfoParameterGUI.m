function varargout = InfoParameterGUI(varargin)

% InfoParameterGUI('init', ParamStruct) - initializes a GUI with edit boxes for every field in subfield ParamStruct.GUI
% InfoParameterGUI('sync', ParamStruct) - updates the GUI with fields of
